...
const BUTTON_CLASS =
  'mx-auto mt-5 block w-fit rounded-full bg-brand px-9 py-3 font-heading text-[14px] font-bold uppercase tracking-wider text-white transition-colors hover:bg-brand-deep disabled:opacity-60'
