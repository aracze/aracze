...
const SECONDARY_CLASS =
  'mx-auto block w-fit rounded-full border-2 border-line-strong px-8 py-2.5 font-heading text-label font-bold uppercase tracking-wider text-ink-2 transition-colors hover:border-brand hover:text-brand'
