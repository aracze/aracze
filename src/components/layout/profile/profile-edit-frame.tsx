    ...
    <div className="mx-auto mt-7 max-w-[560px] border-t border-line pt-5">
      ...
      <div className="flex flex-wrap items-center justify-center gap-x-4 gap-y-2">
        <button
          type="submit"
          disabled={pending}
          className="whitespace-nowrap rounded-full bg-brand px-8 py-2.5 font-heading text-[13px] font-bold uppercase tracking-wider text-white transition-colors btn-lift disabled:cursor-not-allowed disabled:opacity-60"
        >
