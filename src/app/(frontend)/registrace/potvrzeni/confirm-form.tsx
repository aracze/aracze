  ...
  if (result === 'ok') {
    return (
      <div className="text-center">
        ...
        <Link
          href="/prihlaseni"
          className="mx-auto mt-6 block w-fit rounded-full bg-brand px-9 py-3 font-heading text-[14px] font-bold uppercase tracking-wider text-white transition-colors btn-lift"
        >
          Přihlásit se
        </Link>
      </div>
    ...
    <div className="text-center">
      ...
      <form action={formAction}>
        ...
        <button
          type="submit"
          disabled={isPending}
          className="mx-auto mt-6 block w-fit rounded-full bg-brand px-9 py-3 font-heading text-[14px] font-bold uppercase tracking-wider text-white transition-colors btn-lift disabled:cursor-default disabled:opacity-60"
        >
